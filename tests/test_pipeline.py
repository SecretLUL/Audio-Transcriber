...
class TestFinalizer(unittest.TestCase):
    def setUp(self):
        ...
        self._orig_out, self._orig_tmp = pipeline.OUT_DIR, pipeline.TMP_DIR
        pipeline.OUT_DIR, pipeline.TMP_DIR = self.out, self.tmp
    ...
    def tearDown(self):
        pipeline.OUT_DIR, pipeline.TMP_DIR = self._orig_out, self._orig_tmp
